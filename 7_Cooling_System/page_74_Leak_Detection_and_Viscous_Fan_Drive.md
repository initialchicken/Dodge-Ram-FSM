...
The black light can be used in conjunction with a pressure tester to determine if any external leaks exist (Fig. 17).

![Fig. 17 Leak Detection Using Black Light—Typical
- Typical black light tool](page_74_fig_17.jpg)
...
**WARNING: DO NOT REMOVE CYLINDER HEAD DRAIN PLUGS OR LOOSEN RADIATOR DRAINCOCK WITH SYSTEM UNDER PRESSURE. VERY SERIOUS BURNS FROM COOLANT CAN OCCUR.**
