...
- CKP HOLDOWN BRACKET
- MOUNTING BOLT
- OIL DIPSTICK TUBE](page_46_fig_8.jpg)

*Fig. 8 Crankshaft Position Sensor (CKP) Location*

![Fig. 9 Crankshaft Tone Wheel
- MISSING ENGINE TOOTH
- CRANKSHAFT
- TONE WHEEL
- WHEEL TEETH](page_46_fig_10.jpg)

*Fig. 10 Crankshaft Tone Wheel*

### ENGINE COOLANT TEMPERATURE (ECT) SENSOR—ECM INPUT

The engine coolant temperature sensor is installed into the front of the cylinder head near to the thermostat housing (Fig. 10) and protrudes into a water jacket. The sensor provides an input voltage to the Engine Control Module (ECM) to monitor coolant temperature. The ECM uses this input along with inputs from other sensors for engine protection, fuel timing and fuel control. As coolant temperature varies, the coolant temperature sensor resistance will change. This change in resistance results in a different input voltage to the ECM.

[Figure: Fig. 10 Engine Coolant Temperature Sensor
- ELECTRICAL CONNECTOR
...
The other fuel temperature sensor is located in the top of the fuel filter housing and is serviceable. It is used to control the fuel heater element. Refer to Fuel Heater Description and Operation for additional information.
...
The intake manifold air temperature sensor is installed into the rear of the intake manifold (Fig. 11) with the sensor element extending into the air stream.