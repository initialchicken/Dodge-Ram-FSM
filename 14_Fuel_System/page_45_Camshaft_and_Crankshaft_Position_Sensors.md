...
The Camshaft Position Sensor (CMP) (Fig. 6) contains a hall effect device called a sync signal generator to generate a sync signal.
...
The CMP is located below the fuel injection pump (Fig. 7). It is attached to the back of the timing gear cover housing.
...
- O-RING
- CMP SENSOR
- CMP HEX HEAD BOLT](page_45_fig_6.jpg)

*Fig. 6 Camshaft Position Sensor (CMP)*

![Fig. 7 Camshaft Position Sensor (CMP) Location
- ELECTRICAL CONNECTOR
- CMP MOUNTING BOLT (HEX HEAD)
- SENSOR
- FUEL INJECTION PUMP](page_45_fig_7.jpg)

*Fig. 7 Camshaft Position Sensor (CMP) Location*

### CRANKSHAFT POSITION SENSOR (CKP)—ECM INPUT

The Crankshaft Position Sensor (CKP) is located on the lower left-rear side of the engine behind the starter motor (Fig. 8).
...
Refer to Group 8E, Instrument Panel and Gauges for additional information.