# 21 - 234 TRANSMISSION AND TRANSFER CASE
...
(7) Remove dipstick (Fig. 11) and check fluid level as follows:
...
(d) If fluid is low, add only enough Mopar® ATF Plus 3 to restore correct level. Do not overfill.
...
- DIPSTICK
- HOT
- MAXIMUM ACCEPTABLE FLUID LEVEL
- CORRECT FLUID LEVEL
- 8CJ1486m](page_234_fig_11.jpg)
...
(3) Remove bolts holding front and sides of pan to transmission (Fig. 12).
...
(9) Remove screws holding filter to valve body (Fig. 13).
...
![Fig. 12 Transmission Pan
- TRANSMISSION
- GASKET
- PAN
- BOLTS](page_234_fig_12.jpg)

*Fig. 12 Transmission Pan*

#### INSPECTION

[Figure: Fig. 13 Transmission Filter
- TRANSMISSION
- FILTER
- 8BG1506]
